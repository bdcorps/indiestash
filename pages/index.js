  ...
  return (
    <div className="text-center">
      ...
      <div className="flex flex-wrap my-6">
        ...
        {/* <Link href="/top-book-to-read-on-business-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Business</a></Link>

        <Link href="/top-book-to-read-on-copywriting-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Copywriting</a></Link>

        <Link href="/top-book-to-read-on-psychology-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Psychology</a></Link>

        <Link href="/top-book-to-read-on-bitcoin-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Bitcoin</a></Link>

        <Link href="/top-book-to-read-on-leadership-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Leadership</a></Link>

        <Link href="/top-book-to-read-on-startups-in-2021"><a className="bg-indigo-700 py-1 px-6 text-white rounded-3xl  m-3">Startups</a></Link> */}
      </div>
